...
enum ts_symbol_identifiers {
  ...
  sym_go_version = 29,
  sym_version = 30,
  sym_module_directive = 31,
  sym_go_directive = 32,
  sym_toolchain_directive = 33,
  sym_toolchain_name = 34,
  sym_godebug_directive = 35,
  sym_godebug_spec = 36,
  ...
  aux_sym_godebug_directive_repeat1 = 49,
  aux_sym_require_directive_repeat1 = 50,
  aux_sym_exclude_directive_repeat1 = 51,
  aux_sym_replace_directive_repeat1 = 52,
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_godebug_directive] = "godebug_directive",
  ...
  [aux_sym_godebug_directive_repeat1] = "godebug_directive_repeat1",
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_godebug_directive] = sym_godebug_directive,
  ...
  [aux_sym_godebug_directive_repeat1] = aux_sym_godebug_directive_repeat1,
...
static const TSSymbolMetadata ts_symbol_metadata[] = {
  ...
  [aux_sym_godebug_directive_repeat1] = {
    .visible = false,
    .named = false,
  },
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_toolchain_directive] = STATE(26),
    [sym_godebug_directive] = STATE(26),
    [sym_require_directive] = STATE(26),
    [sym_exclude_directive] = STATE(26),
    [sym_replace_directive] = STATE(26),
    [sym_retract_directive] = STATE(26),
    [sym_comment] = STATE(1),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(67),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(72),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [39] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(27),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(28),
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(29),
  [48] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__string_literal, 1, 0, 0),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__string_literal, 1, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpreted_string_literal, 2, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpreted_string_literal, 2, 0, 0),
  ...
  [67] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_retract_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [70] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_retract_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(106),
  [73] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_retract_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(153),
  [76] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_retract_directive_repeat1, 2, 0, 0),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_retract_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(80),
  ...
  [123] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_require_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(118),
  [126] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_require_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(108),
  [129] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_require_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_require_directive_repeat1, 2, 0, 0),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_exclude_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(118),
  [137] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_exclude_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(108),
  [140] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_exclude_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_exclude_directive_repeat1, 2, 0, 0),
  ...
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_require_spec, 3, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_require_spec, 3, 0, 0),
  ...
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_go_directive, 3, 0, 0),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_go_directive, 3, 0, 0),
  ...
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__directive, 1, 0, 0),
  [182] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__directive, 1, 0, 0),
  [184] = {.entry = {.count = 1, .reusable = false}}, SHIFT(126),
  [186] = {.entry = {.count = 1, .reusable = false}}, SHIFT(135),
  [188] = {.entry = {.count = 1, .reusable = false}}, SHIFT(162),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_retract_spec, 2, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_retract_spec, 2, 0, 0),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_path, 1, 0, 0),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_module_path, 1, 0, 0),
  [198] = {.entry = {.count = 1, .reusable = false}}, SHIFT(156),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module_directive, 2, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_module_directive, 2, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_toolchain_name, 1, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_toolchain_name, 1, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_toolchain_directive, 2, 0, 1),
  [210] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_toolchain_directive, 2, 0, 1),
  [212] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exclude_spec, 3, 0, 0),
  [214] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_exclude_spec, 3, 0, 0),
  [216] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_godebug_spec, 1, 0, 0),
  [218] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_godebug_spec, 1, 0, 0),
  [220] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_godebug_directive, 2, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_godebug_directive, 2, 0, 0),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_godebug_directive, 5, 0, 0),
  [226] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_godebug_directive, 5, 0, 0),
  [228] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_godebug_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(102),
  [231] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_godebug_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(112),
  [234] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_godebug_directive_repeat1, 2, 0, 0), SHIFT_REPEAT(103),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_godebug_directive_repeat1, 2, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_require_directive, 5, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_require_directive, 5, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exclude_directive, 2, 0, 0),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_exclude_directive, 2, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exclude_directive, 5, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_exclude_directive, 5, 0, 0),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replace_directive, 5, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replace_directive, 5, 0, 0),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replace_directive, 2, 0, 0),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replace_directive, 2, 0, 0),
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replace_spec, 4, 0, 0),
  [261] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replace_spec, 4, 0, 0),
  [263] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_retract_directive, 5, 0, 0),
  [265] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_retract_directive, 5, 0, 0),
  [267] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_retract_directive, 2, 0, 0),
  [269] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_retract_directive, 2, 0, 0),
  ...
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_godebug_directive, 6, 0, 0),
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_godebug_directive, 6, 0, 0),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_require_directive, 6, 0, 0),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_require_directive, 6, 0, 0),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_exclude_directive, 6, 0, 0),
  [285] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_exclude_directive, 6, 0, 0),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replace_directive, 6, 0, 0),
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replace_directive, 6, 0, 0),
  [291] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_replace_spec, 5, 0, 0),
  [293] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_replace_spec, 5, 0, 0),
  ...
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_require_directive, 2, 0, 0),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_require_directive, 2, 0, 0),
  ...
  [327] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_godebug_directive_repeat1, 1, 0, 0),
  ...
  [335] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_replace_directive_repeat1, 1, 0, 0),
  ...
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file_path, 1, 0, 0),
  ...
  [436] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_go_version, 1, 0, 0),
